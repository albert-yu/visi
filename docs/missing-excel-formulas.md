...
ABS, ACOS, AND, ASIN, ATAN, AVEDEV, AVERAGE, AVERAGEA, AVERAGEIF,
AVERAGEIFS, BETA.DIST, BETA.INV, BINOM.DIST, BINOM.DIST.RANGE, BINOM.INV,
CEILING, CHISQ.DIST, CHISQ.DIST.RT, CHISQ.INV, CHISQ.INV.RT, CHISQ.TEST,
CHOOSE, CONCAT, CONCATENATE, CONFIDENCE.NORM, CONFIDENCE.T, CORREL, COS,
COUNT, COUNTA, COUNTBLANK, COUNTIF, COUNTIFS, COVARIANCE.P, COVARIANCE.S,
CUMIPMT, CUMPRINC, DB, DDB, DEVSQ, DOLLARDE, DOLLARFR, EFFECT, EXP,
EXPON.DIST, F.DIST, F.DIST.RT, F.INV, F.INV.RT, F.TEST, FALSE, FISHER,
FISHERINV, FLOOR, FORECAST, FORECAST.ETS, FORECAST.ETS.CONFINT,
...
GAUSS, GEOMEAN, GROWTH, HARMEAN, HYPGEOM.DIST, IF, IFERROR, INDEX, INT,
INTERCEPT, IPMT, IRR, ISBLANK, ISERROR, ISNA, ISNUMBER, ISPMT, ISTEXT,
KURT, LARGE, LEFT, LEN, LINEST, LN, LOG10, LOGEST, LOGNORM.DIST,
LOGNORM.INV, LOWER, MATCH, MAX, MAXA, MAXIFS, MEDIAN, MID, MIN, MINA,
MINIFS, MIRR, MMULT, MOD, MODE.MULT, MODE.SNGL, NEGBINOM.DIST, NOMINAL,
NORM.DIST, NORM.INV, NORM.S.DIST, NORM.S.INV, NOT, NOW, NPER, NPV, OR,
PEARSON, PDURATION, PERCENTILE.EXC, PERCENTILE.INC, PERCENTRANK.EXC,
PERCENTRANK.INC, PERMUT, PERMUTATIONA, PHI, PMT, POISSON.DIST, PPMT, PROB,
PRODUCT, PROPER, PV, QUARTILE.EXC, QUARTILE.INC, RAND, RANDBETWEEN,
RANK.AVG, RANK.EQ, RATE, RIGHT, ROUND, ROUNDDOWN, ROUNDUP, RRI, RSQ, SIN,
SKEW, SKEW.P, SLN, SLOPE, SMALL, SQRT, STANDARDIZE, STDEV.P, STDEV.S,
STDEVA, STDEVPA, STEYX, SUM, SUMIF, SUMIFS, SYD, T.DIST, T.DIST.2T,
T.DIST.RT, T.INV, T.INV.2T, T.TEST, TAN, TODAY, TREND, TRIMMEAN, TRIM,
TRUE, UPPER, VAR.P, VAR.S, VARA, VARPA, VDB, VLOOKUP, WEIBULL.DIST, XIRR,
XLOOKUP, XNPV, Z.TEST
