...
- Every code comment (single-line, multi-line, docstrings, or inline explanations)
  introduced or modified by you MUST begin with an attribution tag specifying your model name and version.
- Format: `[<Model_Name_Version>] <Comment Text>`
- Language-specific syntax:
  - Python / Shell / YAML: `# [<Model_Name_Version>] ...`
  - JavaScript / TypeScript / C++ / Go / Rust: `// [<Model_Name_Version>] ...`
  - Block comments: `/* [<Model_Name_Version>] ... */`
- Never remove, alter, or overwrite existing model attribution tags generated by previous model versions unless explicitly instructed.
- If you are unaware of your exact version identifier at runtime, default to: `[AI-Agent]`.
